...
const MedicalTriagePlatform = () => {
  ...
  useEffect(() => {
    async function loadHorarios() {
      try {
        ...
        const horarios = data.horarios; // <-- AQUI ESTAVA O PROBLEMA
        if (!Array.isArray(horarios)) {
          console.error(
            "Backend não retornou array. Valor retornado:",
            horarios
          );
          return;
        }

        // Agrupar por data (igual ao JSON fake que você tinha)
        const grouped = {};
        ...
        horarios.forEach((h) => {
          ...
          grouped[date].push({
            time,
            patient: h.paciente || null,
            idade: h.idade || null,
            peso: h.peso || null,
            height: h.altura || null,
            conditions: h.comorbidades || null,
            details: h.detalhes || null,
            phone: h.telefone || null,
          });
        });
  ...
  //       height: 178,
  //       conditions: "Nenhuma",
  //       details: "Dor nas costas há 3 dias",
  //       phone: "(85) 91234-5678",
  //     },
  ...
  //       details: "Revisão de medicamentos",
  //       phone: "(85) 95432-1098",
  //     },
  //     {
  //       time: "10:00",
  ...
  //       height: 163,
  //       conditions: "Nenhuma",
  //       details: "Dor de cabeça recorrente",
  //       phone: "(85) 94321-0987",
  //     },
  //     {
  //       time: "11:00",
  ...
  //       height: 176,
  //       conditions: "Nenhuma",
  //       details: "Exames de rotina",
  //       phone: "(85) 93210-9876",
  //     },
  //     {
  //       time: "14:00",
  //       patient: "Juliana Melo",
  //       age: 38,
  //       weight: 64,
  //       height: 161,
  //       conditions: "Tireoide",
  //       details: "Acompanhamento endócrino",
  //       phone: "(85) 92109-8765",
  //     },
  //     {
  //       time: "15:00",
  //       patient: "Ricardo Barbosa",
  //       age: 50,
  //       weight: 95,
  //       height: 180,
  //       conditions: "Diabetes, Obesidade",
  //       details: "Consulta nutricional",
  //       phone: "(85) 91098-7654",
  //     },
  //     {
  //       time: "16:00",
  ...
  //       height: 165,
  //       conditions: "Nenhuma",
  //       details: "Resultado de exames",
  //       phone: "(85) 90987-6543",
  //     },
  //     {
  //       time: "17:00",
  //       patient: "Gabriel Martins",
  //       age: 26,
  //       weight: 73,
  //       height: 174,
  //       conditions: "Nenhuma",
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              <div>
                ...
                <span className="font-medium">{apt.idade} anos</span>
              </div>
              <div>
                <span className="text-gray-600">Peso:</span>{" "}
                <span className="font-medium">{apt.peso} kg</span>
              </div>
              <div>
                <span className="text-gray-600">Altura:</span>{" "}
                <span className="font-medium">{apt.height} m</span>
              </div>
            ...
            <div className="flex items-start space-x-2 pt-2 border-t">
              ...
              <div>
                <div className="text-sm">
                  <span className="text-gray-600">Comorbidades:</span>{" "}
                  <span className="font-medium">{apt.conditions}</span>
                </div>
              </div>
            </div>
            <div className="flex items-start space-x-2">
              ...
              <div>
                <div className="text-sm">
                  ...
                  <span className="font-medium">{apt.details}</span>
                </div>
              </div>
            </div>
          </div>
